...
master-01         Ready    control-plane   1h    v1.28.0
master-02         Ready    control-plane   55m   v1.28.0
master-03         Ready    control-plane   50m   v1.28.0
worker-01         Ready    worker          45m   v1.28.0
worker-02         Ready    worker          40m   v1.28.0
...
# 2. 升级 kubelet
sudo apt install -y kubelet=1.29.0-* kubectl=1.29.0-*
